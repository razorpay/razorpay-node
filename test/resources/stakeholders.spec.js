...
describe('STAKEHOLDERS', () => {
  it('Create an stakeholder', (done) => {
    ...
    rzpInstance.stakeholders.create(TEST_ACCOUNT_ID, mockRequest).then((response) => {
      assert.equal(
  ...
  it('Edit Stakerholder', (done) => {
    ...
    rzpInstance.stakeholders.edit(TEST_ACCOUNT_ID, TEST_STAKEHOLDER_ID, mockRequest).then((response) => {
      assert.equal(
        response.__JUST_FOR_TESTS__.url,
  ...
  it('Stakeholder fetch', (done) => {
    ...
    rzpInstance.stakeholders.fetch(TEST_ACCOUNT_ID, TEST_STAKEHOLDER_ID).then((response) => {
      assert.equal(
        response.__JUST_FOR_TESTS__.url,
        `/v2/accounts/${TEST_ACCOUNT_ID}/stakeholders/${TEST_STAKEHOLDER_ID}`,
  ...
  it('fetch stakeholder document ', (done) => {
    ...
    rzpInstance.stakeholders.fetchStakeholderDoc(TEST_ACCOUNT_ID, TEST_STAKEHOLDER_ID).then((response) => {
      assert.equal(
        response.__JUST_FOR_TESTS__.url,
