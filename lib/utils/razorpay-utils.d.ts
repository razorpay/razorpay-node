...
export interface RazorpayVerifyInvoicePayment extends RazorpayWebhook {
    /**
     * Unique identifier of the invoice generated by Razorpay.
     * Example: "inv_KY9Xb8W2Xx1e1A"
     */
    invoice_id: string;

    /**
     * Internal reference ID (or receipt ID) provided by the business at the time of invoice creation.
     * This is typically set using the `reference_id` field.
     * Example: "order_rcptid_11"
     * 
     * Note: May be null or undefined if not provided during invoice creation.
     */
    invoice_receipt_id: string;

    /**
     * Current status of the invoice.
     * This will usually be `"paid"` if the payment was completed successfully.
     * Example: "paid"
     */
