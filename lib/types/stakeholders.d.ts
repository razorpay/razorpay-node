...
export declare namespace Stakeholders {
    interface RazorpayStakeholderBaseRequestBody {
         ...
         */
        relationship?: TypeExecutive | TypeDirector
        /**
    ...
    interface RazorpayStakeholderUpdateRequestBody extends Omit<RazorpayStakeholderBaseRequestBody, 'email' | 'name'> { }
...
declare function stakeholders(api: any): {
    ...
    */
    ...
    all(accountId: string, callback: (err: INormalizeError | null, data: Promise<{
        entity: string,
        count: number,
        items: Array<Stakeholders.RazorpayStakeholder>
    }>) => void): void;
