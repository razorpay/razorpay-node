...
declare function webhooks(api: any): {
    ...
    */
    ...
    all(params: RazorpayPaginationOptions, accountId: string | null, callback: (err: INormalizeError | null, data: Promise<{
        entity: string,
        count: number,
        items: Array<Webhooks.RazorpayWebhook>
    }>) => void): void;        
    ...
    * 
    */
    delete(webhookId: string, accountId: string): Promise<Webhooks.RazorpayWebhook>
    delete(webhookId: string, accountId: string, callback: (err: INormalizeError | null, data: Promise<Webhooks.RazorpayWebhook>) => void): void;
}
